...
// (1) Edit the API keys.
// You can get a free API key pair here: https://dashboard.blockchainapi.com/#api-keys
// Note: It is free to contribute your API to our program!
...
if (APISecretKey.apiKey == null || APIKeyID.apiKey == null) {
    throw Error("Insert your API keys! You can get some here: https://dashboard.blockchainapi.com/#api-keys")
}
...
// (2) DANGER ZONE: This function deletes all of your projects. We created this so that you can easily
// delete all of your projects after testing.
const cleanUp = async () => {
...
const main = async () => {
    ...
    // and the `project_id` to `PROJECT_API_INSTANCE.updateProject`.
    ...
    // The ID of the project. This was created 
    ...
    console.log("*** IMPORTANT NOTE ***: Your `project_id` is `" + projectId + "`. You will use this to deploy the project later.")
}
